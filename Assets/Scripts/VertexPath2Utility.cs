...
namespace Assets.Scripts {
    public static class VertexPath2Utility {
        ...
        public static PathSplitData SplitBezierPathByAngleError(BezierPath bezierPath, float maxAngleError, float minVertexDst, float accuracy) {
            ...
            Vector2 prevPointOnPath = bezierPath[0];
            Vector2 lastAddedPoint = bezierPath[0];
            ...
            for ( int segmentIndex = 0; segmentIndex < bezierPath.NumSegments; segmentIndex++ ) {
                ...
                for ( float t = increment; t <= 1; t += increment ) {
                    ...
                    Vector2 pointOnPath = CubicBezierUtility.EvaluateCurve(segmentPoints, t);
                    Vector2 nextPointOnPath = CubicBezierUtility.EvaluateCurve(segmentPoints, t + increment);
